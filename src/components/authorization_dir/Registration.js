...
function Registration() {
    ...
    return (
        <div className="products-list registration">
            ...
            <div className="registration__main">
                ...
                <form onSubmit={submiter}>
                    ...
                    })} className="registration__main--mid">
                        <div>
