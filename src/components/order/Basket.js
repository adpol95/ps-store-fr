...
function Basket() {
    ...
    return (
        <div className="products-list basket">
                    ...
                    <ul>
                        {
                            dataCart.map((el, i) => <li key={Math.floor(Math.random() * 100 - 1) * i}
                                ...
                                <div className="basket__main--quantity">
                                    Price: <i>{el.Price}</i>
                                    <div>Quantity:</div>
                                    <div className="basket__main--amount">
                                        <button
                                            onClick={(event) => setRemPlusMinEffect([{...el}, event.target.innerText])}>-
                                        </button>
                                        <i>{el.amount}</i>
                                        <button
                                            onClick={(event) => setRemPlusMinEffect([{...el}, event.target.innerText])}>+
